...
# config
# {
#     "m" : 200,  # number of clients during training
#     "m_test" : 40, # number of clients during testing
#     "p" : 2, # number of clusters
#     "n" : 500, # number of data per client

#     "participation_rate":0.1, # rate of participating nodes at each round

#     "num_epochs": 600, # number of rounds of training

#     "batch_size":50, # local minibatch size
#     "tau":5, # number of local epochs
...
CIFAR10_TRAINSET_DATA_SIZE = 2500  #!! 50000
CIFAR10_TESTSET_DATA_SIZE = 2500 # !! 10000
...
class TrainCIFARCluster(object):
    ...
    def setup_model(self):
        ...
        self.x_pl = tf.placeholder(tf.float32, shape=(None, IMAGE_SIZE, IMAGE_SIZE, 3), name='input_x')   # !!!
    ...
    def train(self, lr):
        ...
        for m_i2, m_i in enumerate(participating_nodes):
            ...
            for l_epoch in range(tau): # local epochs
                ...
                X_train = X_train[:self.config['n']]
                y_train = y_train[:self.config['n']]
